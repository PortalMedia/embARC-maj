...
@MediaClass(uuid1 = 0x01100600, uuid2 = 0x0000, uuid3 = 0x0000,
		  uuid4 = {0x06, 0x0e, 0x2b, 0x34, 0x01, 0x04, 0x01, 0x01},
		  definedName = "TypeDefinitionUtf8",
		  ...
		  symbol = "TypeDefinitionUtf8")
public final class TypeDefinitionUtf8Impl 
	extends 
	...
	/** <p></p> */
	private static final long serialVersionUID = -36249294285478L;
	
	private WeakReference<TypeDefinition> elementType;
	private transient Charset charSet = Charset.forName("UTF-8");
	
	protected TypeDefinitionUtf8Impl() { }
	
	public TypeDefinitionUtf8Impl(
			AUID identification,
	...
	public static abstract class BaseStringValue
		...
		private TypeDefinitionUtf8Impl type;
		
		protected void setType(
				TypeDefinitionUtf8Impl type) {
			
			this.type = type;
		}

		public TypeDefinitionUtf8Impl getType() {
	...
	public PropertyValue createFromBytes(
		...
		try {
			checkForNulls = new String(characters, "UTF-8");
